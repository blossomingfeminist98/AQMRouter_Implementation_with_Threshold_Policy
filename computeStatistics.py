...
for i in queue_size:
    for j in round_trip_time:
        if(i=="Threshold100" or i=="Threshold15"):
            f1 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "msRTTth.txt"
            f2 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "msRTTU.txt"
            f3 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "msRTTQS.txt"
            f4 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "msRTTLoss.txt"
        else: 
            f1 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "RTTth.txt"
            f2 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "RTTU.txt"
            f3 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "RTTQS.txt"
            f4 = "./FinalResults/TCPLinuxReno/" + i + "/" + i + str(j) + "RTTLoss.txt"
